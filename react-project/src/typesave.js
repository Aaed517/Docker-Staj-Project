              ...
              <Row >
                <Col>
                  <FormGroup style={{ height: 100, marginLeft: "1%" }}>
                    <Label for="exampleEmail" style={{ width: 100 }} >Tür Adı</Label>
                    <Input    name="yazar"value={this.state.text}  onChange={this.handleChangeWriter.bind(this)} id="yazar" placeholder="Tür" style={{ height: 125, width: 500 }} />
                  </FormGroup>
                </Col>
              </Row>
